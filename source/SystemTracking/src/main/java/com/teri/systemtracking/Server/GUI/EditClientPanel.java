...
public class EditClientPanel extends javax.swing.JPanel {
      ...
      private EventObservationPanel eventObservationPanel;
      ...
      public void showFileSelectionPanel() {
            showPanel("file selection");
      }

      public void showObservedListPanel() {
            showPanel("observed events");
      }

      private void showPanel(String s) {
            ((CardLayout) cardLayout.getLayout()).show(cardLayout, s);
      }

      public EventObservationPanel getObservedListPanel() {
      ...
      private void initComponents() {
            ...
            eventObservationPanel = new EventObservationPanel();
            ...
            cardLayout.add(fileSelectionPanel1, "file selection");
            cardLayout.add(eventObservationPanel, "observed events");
